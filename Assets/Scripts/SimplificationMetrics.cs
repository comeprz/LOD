...
namespace LOD
{
    ...
    public static class SimplificationMetrics
    {
        public struct Result
        {
            ...
            public int vertices;
            public float meanSquaredError; // symétrique
            public double simplifyMs;      // temps de la passe de simplification
        ...
        {
            // faces vivantes de "to" (triplets de positions)
            ...
            // points sources = sommets vivants de "from"
